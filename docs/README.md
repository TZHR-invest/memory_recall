...
| [initiatives/crystal/README.md](initiatives/crystal/README.md) | ACTIVE | 2026-08-19 | crystal 专项文档包入口（语义 v1 / 落库定稿 / API 契约 / workbench / 对账 / 召回 / 测试策略 / 迁移脚本设计 / 插件切换契约 / 退役检查单 / 里程碑 / PRD；M1–M3 已实现，M4 切换延后，M5 退役待标准；原 target-model 更名，2026-08-18 由 designs/ 迁入 initiatives/） |
