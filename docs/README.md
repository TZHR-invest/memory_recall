...
| [initiatives/crystal/README.md](initiatives/crystal/README.md) | ACTIVE | 2026-08-18 | crystal 专项文档包入口（语义 v1 / 落库定稿 / API 契约 / workbench / 对账 / 召回 / 测试策略 / 迁移 / 里程碑 / PRD；原 target-model 更名，2026-08-18 由 designs/ 迁入 initiatives/） |
