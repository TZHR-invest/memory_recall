...
| dsh 客户端插件（memory-recall-dsh） | 已完成（2026-08-14：5 工具 + 自动召回注入 + 自动捕获；17 测试全绿；headless 真实运行时 E2E 验证通过；已安装到 ~/.dsh web profile，**重启 dsh web 后生效**） | [dsh 插件](../apps/api/src/plugins/dsh/README.md) |
