...
> 系统: crystal
> 日期: 2026-08-16
> 关联: [目标模型](../initiatives/crystal/foundation.md)（已拍板 #8）· [memory-confidence](../notes/2026-08-14-memory-confidence.md)
...
- 生命周期四阶段（写入/召回/消费/维护）与 P0/P1 节奏见 [目标模型](../initiatives/crystal/foundation.md) §置信度与价值信号。
