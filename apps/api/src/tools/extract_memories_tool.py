...
⚠️ 每条记忆内容必须精炼，控制在 30-60 字以内：
- 保留核心事件和关键信息
- 删除冗余描述、情感修饰、场景细节
- 使用简洁的陈述句

精炼示例：
- 原文："晚上回家，发现家人特意做了我最爱吃的菜，等着我一起吃饭。饭桌上，家人聊着日常的琐事，关心我的生活和工作，没有华丽的语言，只有实实在在的关心，心里暖暖的。"
- 精炼："晚上回家和家人吃饭，家人做了爱吃的菜，聊日常琐事。"

- 原文："下午尝试学习了一项新技能，虽然刚开始手忙脚乱，频频出错，甚至一度想要放弃，但还是咬着牙坚持了下来。一遍遍地练习，终于掌握了要领，看着自己的成果，满满的成就感油然而生。"
- 精炼："下午学习新技能，反复练习后掌握要领，有成就感。"
...
输出：
{
  ...
  "time": {"value": "2026-03-23", "original_text": "早上"},
  "entities": [
    {"name": "张三", "type": "person"},
