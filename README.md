...
| 🔀 **多 LLM 支持** | 火山引擎 doubao / DeepSeek，`LLM_PROVIDER` 一键切换 |
| 📊 **可观测性** | Recall Trace 召回链路明细 + embedding 调用日志 + debug/stats API |
...
| LLM | 火山引擎 doubao-seed / DeepSeek（`LLM_PROVIDER=volcengine\|deepseek`） |
...
*创建时间：2026-03-19 · 最后更新：2026-08-10*
